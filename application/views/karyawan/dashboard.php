										...
										<div class="default-tab">
											<nav>
												<div class="nav nav-tabs" id="nav-tab" role="tablist">
													<a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Ruang</a>
                                                        ...
                                                        <div class="col-12 col-md-9">
                                                            ...
                                                            <?php 
                                                                foreach ($ruang as $val ) {
                                                                    ?>
                                                                <option value="<?php echo $val->ID_RUANG?>"><?php echo $val->NAMA_RUANG?> - <?php echo $val->NAMA_GEDUNG?></option>
                                                            <?php   }
                                                            ?>
                                                            </select>
                                                        </div>
