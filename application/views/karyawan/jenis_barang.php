	...
	<div class="page-container">
		...
		<div class="main-content">
          ...
          <!-- //UPDATE -->
                ...
                <div class="row form-group">
									<div class="col col-md-3">
										<label for="hf-email" class=" form-control-label">Jenis</label>
									</div>
									<div class="col-12 col-md-9">
										<input type="text" id="update_name" name="name" placeholder="ex : Meja" class="form-control" required>
									</div>
								</div>
            ...
            <!-- ADD GEDUNG -->
						<div class="card" style="" id="add-form">
							<div class="card-header">
									<strong>Add</strong> new Jenis
							</div>
							<div class="card-body card-block">
									<form action="<?php echo base_url()?>users/jenis/add" method="POST" class="form-horizontal">
											<div class="row form-group">
													<div class="col col-md-3">
															<label for="hf-email" class=" form-control-label">Kode Jenis</label>
													</div>
													<div class="col-12 col-md-9">
															<input type="text" id="hf-email" name="kode" placeholder="ex : KRS_A1" class="form-control" required>
													</div>
											</div>
											<div class="row form-group">
													<div class="col col-md-3">
													...
													<div class="col-12 col-md-9">
															<input type="text" id="hf-email" name="name" placeholder="ex : Kursi" class="form-control" required>
													</div>
											</div>
							</div>
							<div class="card-footer">
										...
										<table class="table table-borderless table-data3" id="myTable">
												...
												<tbody>
														<?php $a=1; foreach($data as $result){?>
																<tr>
																		<td><?php echo $a;?></td>
                                    <td><?php $id= $result->KODE_JENIS;
                                    echo $id;?></td>
																		<td><?php $name = $result->JENIS;
                                    echo $name;?></td>
																		<td class="process">
